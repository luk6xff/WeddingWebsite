...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join('wedding', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#STATIC_ROOT = os.path.join('wedding', 'static')
#STATIC_URL = os.path.join('wedding', 'static')
STATIC_URL = os.path.join('BASE_DIR/wedding', 'static')
STATICFILES_DIRS = [
